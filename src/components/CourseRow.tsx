...
export function CourseRow({ course, index, onChange, onRemove }: CourseRowProps) {
  ...
  return (
    <div className="rounded-lg bg-background border border-border/60 p-3.5 space-y-3 shadow-xs transition-colors hover:border-primary/30">
      {/* Header: Title, GP Badge, Delete Button */}
